...
# 9 "src/external_interrupts.c" 2

# 1 "inc\\external_interrupts.h" 1
# 26 "inc\\external_interrupts.h"
...
# 93 "inc\\external_interrupts.h"
typedef enum { EXT_INT_INT0 = 1u, EXT_INT_INT1 = 2u, EXT_INT_INT2 = 4u } external_interrupts_t;
typedef enum { RISING_EDGE, FALLING_EDGE } external_interrupt_edge_t;



void external_interrupts_init_default(uint8_t which_pins, external_interrupt_edge_t trigger_edge);
